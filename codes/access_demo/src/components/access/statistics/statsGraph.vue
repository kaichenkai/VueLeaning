...
<style scoped>
   ...
   .access-graph .week-month .btn.select {
       background-color: #6c757d;
       color: #fff;
   }

   .access-graph .week-month .btn:focus {
       background-color: #6c757d;
       color: #fff;
   }
</style>
